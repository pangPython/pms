...
CREATE TABLE `project`  (
  ...
  `actual_work_hour` decimal(5, 2) NOT NULL COMMENT '实际总工时',
  ...
  `stage` smallint(6) NOT NULL COMMENT '开发阶段',
  `progress_phase` tinyint(4) NOT NULL COMMENT '进度阶段（1正常，2提前，0滞后，参考SPI）',
  `start_time` datetime(0) NULL DEFAULT NULL COMMENT '实际开始时间',
  `create_user` bigint(20) NOT NULL COMMENT '创建人',
  `is_suspended` smallint(6) NOT NULL COMMENT '是否暂停',
...
CREATE TABLE `t_login_log`  (
  ...
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登录日志表' ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单表' ROW_FORMAT = Dynamic;
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1, 'MrBird', 'cb62ad1497597283961545d608f80241', 1, 'mrbird@qq.com', '17788888888', '1', '2019-06-14 20:39:22', '2019-06-14 20:44:42', '2019-10-10 14:19:13', '0', '1', 'white', 'cnrhVkzwxjPwAaCfPbdc.png', '我是帅比作者。', 0);
...
INSERT INTO `t_user` VALUES (8, 'admin', '1538ea7be58ccf70454ed60bb50e34d0', 10, '', '', '1', '2019-10-10 14:19:32', '2019-10-10 14:25:00', '2019-10-28 09:30:22', '2', '1', 'white', 'default.jpg', '', 7);
